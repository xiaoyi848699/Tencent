package com.xiaoyi.tencent.utils;
...
public class PullToRefreshListView extends ListView{
    ...
    private String  updatedCompleteText;
    ...
    Handler mHandler = new Handler(){
    	public void handleMessage(android.os.Message msg) {
    		 complet_iv.setVisibility(View.GONE);
...
//        lastUpdated = System.currentTimeMillis();
    ...
    private void init(){
        ...
        complet_iv = (ImageView) header.findViewById(R.id.complet_iv);
        ...
        updatedCompleteText = getContext().getString(R.string.updated_complete);
    ...
    public void setUiComplete(){
    	...
    	image.clearAnimation();
    	image.setVisibility(View.INVISIBLE);
    	complet_iv.setVisibility(View.VISIBLE);
    	
    	text.setText(updatedCompleteText);
