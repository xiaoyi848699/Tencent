...
public class PhotoUtil {
	public static String camera_path = Environment.getExternalStorageDirectory().toString()+"/image";
	public static String head_image_path = Environment.getExternalStorageDirectory().toString()+"/head_image";
